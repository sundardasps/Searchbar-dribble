          ...
          <>
            ...
            <div className="flex justify-between px-4 border-b border-gray-200 relative">
              ...
              >
                ...
                <div
                  className="relative"
                  onMouseLeave={() => setOpenDropdown(false)} // closes only when leaving entire wrapper
                >
                  {/* Settings Icon */}
                  <div className="flex items-center justify-center rounded p-1">
                    <Icon.settings
                    ...
                    <ul>
                      {tabs.slice(1).map((item) => (
                        <li
                          ...
                          className="flex items-center w-full gap-1 text-xs font-extralight text-gray-400 cursor-pointer p-2 hover:bg-gray-100"
                        >
                          {item.icon && <item.icon className="w-4 h-4" />}
                          <span
