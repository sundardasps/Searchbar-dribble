...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* 🔹 Credit Footer */}
      <div className="fixed bottom-2 right-4 text-[11px] md:text-sm text-gray-500 opacity-70 hover:opacity-100 transition-opacity">
        Built with ❤️ by
        <a
          href="https://sundardasps-portfolio.vercel.app"
          target="_blank"
